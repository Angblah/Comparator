...
class Comparison(db.Model):
    ...
    id = db.Column(Integer, primary_key=True, db.Sequence('comparison_id_seq', start=0))
...
class ComparisonAttribute(db.Model):
    ...
    id = db.Column(Integer, primary_key=True, db.Sequence('comparison_attribute_id_seq', start=0))
    name = db.Column(String(255), nullable=False)
...
class ComparisonItem(db.Model):
    ...
    id = db.Column(Integer, primary_key=True, db.Sequence('comparison_item_id_seq', start=0))
...
class Template(db.Model):
    ...
    id = db.Column(Integer, primary_key=True, db.Sequence('template_id_seq', start=0))
    name = db.Column(String(255), nullable=False)
...
class TemplateAttribute(db.Model):
    ...
    id = db.Column(Integer, primary_key=True, db.Sequence('template_attribute_id_seq', start=0))
    name = db.Column(String(255), nullable=False)
    type_id = db.Column(SmallInteger, nullable=False)
...
class UserTemplate(db.Model):
    ...
    id = db.Column(Integer, primary_key=True, db.Sequence('user_template_id_seq', start=0))
    name = db.Column(String(255), nullable=False)
    account_id = db.Column(ForeignKey(u'account.id', ondelete=u'CASCADE'), nullable=False)
...
class UserTemplateAttribute(db.Model):
    ...
    id = db.Column(Integer, primary_key=True, db.Sequence('user_template_attribute_id_seq', start=0))
    name = db.Column(String(255), nullable=False)
    type_id = db.Column(SmallInteger, nullable=False)
...
class Account(db.Model):
    ...
    id = db.Column(Integer, db.Sequence('account_id_seq', start=0), primary_key=True)
