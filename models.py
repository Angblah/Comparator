...
class Comparison(db.Model):
    ...
    id = db.Column(Integer, db.Sequence('comparison_id_seq', start=0), primary_key=True)
...
class ComparisonAttribute(db.Model):
    ...
    id = db.Column(Integer, db.Sequence('comparison_attribute_id_seq', start=0), primary_key=True,)
    name = db.Column(String(255), nullable=False)
...
class ComparisonItem(db.Model):
    ...
    id = db.Column(Integer, db.Sequence('comparison_item_id_seq', start=0), primary_key=True)
...
class Template(db.Model):
    ...
    id = db.Column(Integer, db.Sequence('template_id_seq', start=0), primary_key=True)
    name = db.Column(String(255), nullable=False)
...
class TemplateAttribute(db.Model):
    ...
    id = db.Column(Integer, db.Sequence('template_attribute_id_seq', start=0), primary_key=True)
    name = db.Column(String(255), nullable=False)
    type_id = db.Column(SmallInteger, nullable=False)
...
class UserTemplate(db.Model):
    ...
    id = db.Column(Integer, db.Sequence('user_template_id_seq', start=0), primary_key=True)
    name = db.Column(String(255), nullable=False)
    account_id = db.Column(ForeignKey(u'account.id', ondelete=u'CASCADE'), nullable=False)
...
class UserTemplateAttribute(db.Model):
    ...
    id = db.Column(Integer, db.Sequence('user_template_attribute_id_seq', start=0), primary_key=True)
    name = db.Column(String(255), nullable=False)
    type_id = db.Column(SmallInteger, nullable=False)
